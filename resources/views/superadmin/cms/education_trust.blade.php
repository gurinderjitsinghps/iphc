...
@section('title', 'Edit Education Trust Explanation')
@section('content')
@push('styles')
      ...
      <div class="col-lg-12">
        <div class="card card-dark-blue" style="border:none !important;">
          <div class="card-header cus-card-header border-0">
            <span><a href="{{ route('superadmin.cms','t=user') }}" style="color: inherit;">Back</a> > Edit Education Trust Explanation</span>     
          </div>
                    ...
                    <div class="image-upload-box">
                      <div class="preview-image">
                        <div class="image-preview">
                          @if ($education_trust && $education_trust->attachment)
                          <img width="100%" id="preview" src="/storage/{{ $education_trust->attachment }}" />
                            @else
                            <img id="preview" src="">
                          @endif 
                        </div>
                      ...
                      <div class="file-upload">
                        <input name="attachment" type="file" id="fileInput" accept="image/*" onchange="previewImage()" />
