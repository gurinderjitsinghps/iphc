...
@section('title', 'Edit Polocano choose your plan details')
@section('content')
@push('styles')
      ...
      <div class="col-lg-12">
        <div class="card card-dark-blue" style="border:none !important;">
          <div class="card-header cus-card-header border-0">
            <span><a href="{{ route('superadmin.cms','t=user') }}" style="color: inherit;">Back</a> > Edit Polocano choose your plan details</span>     
          </div>
                    ...
                    <div class="image-upload-box">
                      <div class="preview-image">
                        <div class="image-preview">
                          @if ($polocano && $polocano->attachment)
                          <img width="100%" id="preview" src="/storage/{{ $polocano->attachment }}" />
                            @else
                            <img id="preview" src="">
                          @endif 
                        </div>
