      ...
      <div class="col-lg-12">
        <div class="card card-dark-blue" style="border:none !important;">
          <div class="card-header cus-card-header border-0">
            <span><a href="{{ route('superadmin.cms','t=user') }}" style="color: inherit;">Back</a> > Edit Advertisement</span>     
          </div>
                    ...
                    <div class="image-upload-box">
                      <div class="preview-image">
                        <div class="image-preview">
                          @if ($advert && $advert->attachment)
                          <img width="100%" id="preview" src="/storage/{{ $advert->attachment }}" />
                            @else
                            <img src="" id="preview">
                          @endif 
                        </div>
                      ...
                      <div class="file-upload">
                        <input name="attachment" type="file" id="fileInput" accept="image/*" />
                  ...
                  <div class="form-group mb-3 row align-items-center">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        <textarea type="textarea" name="text1" class="form-control custum-textarea" placeholder="Title"  >{{$advert->text1}}</textarea>
                      </div>
                    </div>
                  </div>
                  <div class="form-group mb-3 row align-items-center">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        <textarea type="textarea" name="text2" class="form-control custum-textarea2" placeholder="Details ">{{$advert->text2}}</textarea>
                      </div>
                    </div>
                  </div>
