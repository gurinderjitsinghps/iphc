...
@section('title', 'IPHC admin System')
@section('content')
@push('styles')
          ...
          <div class="table-responsive text-center table-dark-blue" style="padding: 0 20px">
            <table id="id2" class="table align-items-center table-flush stripped-cus-stable">
              ...
              <tr class="si-rw">
                ...
                <td>Splash Screen</td>
                <td>
                  <a class="ml-1" href="{{ route('superadmin.cms.edit_splash_screen') }}"><span class="zmdi zmdi-delete icon-pencil icons text-warning"></span></a>
                </td>
              </tr>
              <tr class="si-rw">
                <td>2</td>
                <td>Intro Screens</td>
                <td>
                  <a class="ml-1" href="{{ route('superadmin.cms.intro_screens') }}"><span class="zmdi zmdi-delete icon-pencil icons text-warning"></span></a>
                </td>
              </tr>
              <tr class="si-rw">
                <td>3</td>
                <td>Help Center</td>
                <td>
                  <a class="ml-1" href="{{ route('superadmin.cms.edit_help_center') }}"><span class="zmdi zmdi-delete icon-pencil icons text-warning"></span></a>
                </td>
              </tr>
              <tr class="si-rw">
                <td>4</td>
                <td>Term & Policy</td>
                <td>
                  <a class="ml-1" href="{{ route('superadmin.cms.edit_terms_policy') }}"><span class="zmdi zmdi-delete icon-pencil icons text-warning"></span></a>
                </td>
              </tr>
            </table>
          <div class="pt-3">
